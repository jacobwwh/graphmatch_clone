...
def createast():
    ...
    paths=[]
    alltokens=[]
    dirname = '/home/lxt/bigclonebenchdata7/'
...
def creategmndata(id,treedict,vocablen,vocabdict,device):
    ...
    print('test data')
    testdata=createpairdataTest(treedict,testlist,device=device)
...
def createpairdata(treedict,pathlist,device):
    ...
    for line in pathlist:
        ...
        code1path = code1path.replace("bigclonebenchdata","bigclonebenchdata7")
        code2path = code2path.replace("bigclonebenchdata","bigclonebenchdata7")
    ...
    return datalist
def createpairdataTest(treedict,pathlist,device):
